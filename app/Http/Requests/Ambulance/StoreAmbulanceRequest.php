...
class StoreAmbulanceRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'vehicle_identifier' => ['required', 'string', 'max:50', 'unique:ambulances,vehicle_identifier'],
            'vehicle_type' => ['required', 'string', 'max:50', Rule::in(['bls', 'als', 'critical_care', 'patient_transport', 'type_i', 'type_ii', 'type_iii', 'medium_duty', 'specialty', 'other'])],
