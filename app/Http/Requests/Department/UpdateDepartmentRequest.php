...
class UpdateDepartmentRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'department_code' => 'sometimes|required|string|max:50',
            ...
            'average_wait_time_minutes' => 'nullable|integer|min:0|max:1440',
    ...
    protected function prepareForValidation(): void
    {
        ...
        if ($this->has('accepts_walk_ins')) {
            $this->merge([
                'accepts_walk_ins' => filter_var($this->accepts_walk_ins, FILTER_VALIDATE_BOOLEAN),
            ]);
        }

        if ($this->has('requires_appointment')) {
            $this->merge([
                'requires_appointment' => filter_var($this->requires_appointment, FILTER_VALIDATE_BOOLEAN),
            ]);
        }
    }
}