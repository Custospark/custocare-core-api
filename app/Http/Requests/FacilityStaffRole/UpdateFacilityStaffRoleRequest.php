...
class UpdateFacilityStaffRoleRequest extends FormRequest
{
    /**
    ...
    public function authorize(): bool
    {
        ...
        // $facilityStaffRole = $this->route('facility_staff_role');
        // return $this->user()->can('update', $facilityStaffRole);
    ...
    public function rules(): array
    {
        return [
            ...
            'role_code' => 'sometimes|string|in:' . implode(',', [
                'attending_physician',
                'resident_physician',
    ...
    protected function failedAuthorization(): void
    {
        throw new HttpResponseException(
            response()->json([
                'success' => false,
                'message' => 'You are not authorized to update this role assignment'
