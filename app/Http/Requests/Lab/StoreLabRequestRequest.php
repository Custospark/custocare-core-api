...
class StoreLabRequestRequest extends FormRequest
{
    ...
    public function messages(): array
    {
        return [
            ...
            'requested_by_staff_id.exists' => 'The selected staff does not exist',
            'reviewed_by_staff_id.exists' => 'The selected staff does not exist',
            'created_by_staff_id.exists' => 'The selected staff does not exist',
