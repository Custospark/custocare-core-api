...
class UpdatePrescriptionItemRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'substitution' => ['nullable', 'string', 'in:Generic substitution allowed,Brand name only - No substitution,Therapeutic substitution allowed (same class),Dispense as written (DAW)'],
        ];
    }
