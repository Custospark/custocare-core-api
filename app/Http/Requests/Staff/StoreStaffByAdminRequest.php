...
class StoreStaffByAdminRequest extends FormRequest
{
    /**
    ...
    public function rules(): array
    {
        return [
            ...
            'employment_status' => 'nullable|in:employed,unemployed,suspended,terminated,retired,credentialing_pending',
