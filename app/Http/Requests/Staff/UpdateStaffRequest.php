...
class UpdateStaffRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            'user_id' => 'sometimes|integer|exists:users,id|unique:staff,user_id,' . $staffId,
            'employee_id' => 'sometimes|string|max:50|unique:staff,employee_id,' . $staffId,
            'professional_title' => 'sometimes|string|max:100',
            ...
            'specialization_codes' => 'sometimes|array',
            'specialization_codes.*' => 'string|max:10',
            'board_certifications' => 'nullable|array',
            'additional_certifications' => 'nullable|array',
            'npi_number' => 'nullable|string|max:20|unique:staff,npi_number,' . $staffId,
            'dea_number_encrypted' => 'nullable|string|max:512',
            'dea_expiry_date' => 'nullable|date|after:today',
            
            'employment_status' => 'sometimes|in:active,on_leave,suspended,terminated,retired,credentialing_pending',
            'employment_type' => 'sometimes|in:full_time,part_time,contract,locum_tenens,volunteer',
            ...
            'can_supervise_trainees' => 'sometimes|boolean',
            'can_order_controlled_substances' => 'sometimes|boolean',
            'can_sign_death_certificates' => 'sometimes|boolean',
            
            'global_role_level' => 'sometimes|in:super_admin,facility_admin,department_head,attending_physician,fellow,resident,nurse_practitioner,physician_assistant,registered_nurse,licensed_practical_nurse,pharmacist,therapist,technician,support_staff',
    ...
    protected function failedAuthorization(): void
    {
        throw new HttpResponseException(
            response()->json([
                'success' => false,
                'message' => 'You are not authorized to update this staff record.'
