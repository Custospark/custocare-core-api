...
class UpdateDischargeRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'discharge_diagnosis' => 'sometimes|nullable|string|max:5000',
            'discharge_instructions' => 'sometimes|nullable|string|max:5000',
            'discharge_medications' => 'sometimes|nullable|array',
            ...
            'followup_scheduled_at' => 'sometimes|nullable|date',
            'followup_provider_staff_id' => 'sometimes|nullable|integer|exists:staff,id',
