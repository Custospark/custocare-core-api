...
class UpdateVisitCurrentStateRequest extends FormRequest
{
    /**
    ...
    public function authorize(): bool
    {
        ...
        // Example: return $this->user()->can('update', VisitCurrentState::class);
        return true;
    }
    ...
    {
        $visitCurrentStateId = $this->route('visit_current_state') ?? $this->route('id');
        
        return [
            'visit_id' => 'sometimes|integer|exists:visits,id|unique:visit_current_states,visit_id,' . $visitCurrentStateId,
            ...
            'total_wait_minutes' => 'nullable|integer|min:0|max:1440',
            'current_phase_duration_minutes' => 'nullable|integer|min:0|max:1440',
            'next_scheduled_action_at' => 'nullable|date',
            ...
            'has_critical_alerts' => 'sometimes|boolean',
            'acuity_score' => 'sometimes|integer|min:1|max:5',
            ...
            'estimated_minutes_remaining' => 'nullable|integer|min:0|max:10080',
