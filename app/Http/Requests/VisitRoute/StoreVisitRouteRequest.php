...
class StoreVisitRouteRequest extends FormRequest
{
    ...
    {
        return $this->user()->can('create', \App\Models\VisitRoute::class);
    }
    ...
    public function messages(): array
    {
        return [
            ...
            'to_department_id.required' => 'The destination department is required.',
            'to_department_id.exists' => 'The selected destination department does not exist.',
            'routing_reason.required' => 'The routing reason is required.',
            'routing_reason.in' => 'The selected routing reason is invalid.',
            'routed_at.required' => 'The routing timestamp is required.',
    ...
    protected function failedAuthorization(): void
    {
        $response = new JsonResponse([
            'success' => false,
            'message' => 'You are not authorized to create visit routes.',
