...
interface SubscriptionServiceInterface
{
    ...
    public function activateSubscription(Subscription $subscription, Payment $payment, Staff $approvedBy): Subscription;
    public function renewSubscription(Subscription $subscription, Payment $payment, Staff $approvedBy): Subscription;
